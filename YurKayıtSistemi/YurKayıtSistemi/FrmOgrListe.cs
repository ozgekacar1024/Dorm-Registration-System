...
namespace YurKayıtSistemi
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'yurtOtomasyonDataSet7.Ogrenci' table. You can move, or remove it, as needed.
            this.ogrenciTableAdapter.Fill(this.yurtOtomasyonDataSet7.Ogrenci);
